...
function _campaignDefaults() {
  return {
    ...
    unlockedDomains:       [],   // domain/stage ids unlocked for play
...
const CAMPAIGN_PART_META = {
  ...
  18: { title:'Lady Sorya',             chapter:4, act:2, world:1,
        ...
        codexUnlocks:['sorya','domain_basics'],
        rewards:{ coins:100, xp:40 } },
  ...
  30: { title:'The Friend Who Returned',chapter:6, act:3, world:2,
        ...
        codexUnlocks:['mr_clone','sorya_domain_2'],
        rewards:{ coins:150, xp:50 } },
  ...
  37: { title:'Blood Moon Camp',        chapter:8, act:4, world:2,
        ...
        rewards:{ coins:225, xp:80 } },
  38: { title:'Domain of Chains',       chapter:8, act:4, world:2,
        missionType:'rescue',     characterUnlocks:[], rescueFlags:['friend_pending'],
        campEvent:null, teacherUnlock:null,
        codexUnlocks:['friend','kaith','chain_domain'],
        rewards:{ coins:225, xp:80 } },
  ...
  41: { title:'Null Chapel',            chapter:9, act:5, world:3,
        missionType:'boss',       characterUnlocks:[], rescueFlags:[],
        campEvent:null, teacherUnlock:'kaizen',
        codexUnlocks:['rhaziel_domain','rage_tier2','null_field'],
  ...
  48: { title:"Noxrael's Choir",        chapter:10, act:5, world:3,
        missionType:'boss',       characterUnlocks:[], rescueFlags:[],
        campEvent:null, teacherUnlock:null,
        codexUnlocks:['noxrael','choir_domain'],
        rewards:{ coins:300, xp:110 } },
...
const ROSTER_DATA = [
  ...
  { id:'chug',      name:'CHUG',        icon:'🥊',
    ...
    rageCompatible:true,  weaponType:'Fists / Any', domainType:'None (yet)',
  ...
  { id:'solo',      name:'SOLO',        icon:'🔥',
    ...
    rageCompatible:true,  weaponType:'Bare hands', domainType:'Static',
  ...
  { id:'tora_oni',  name:'TORA ONI',    icon:'🐯',
    ...
    rageCompatible:true,  weaponType:'Heavy arms', domainType:'Oath-pressure',
  ...
  { id:'addy',      name:'ADDY',        icon:'💨',
    ...
    rageCompatible:false, weaponType:'Light blades', domainType:'Echo-shift',
  ...
  { id:'legend',    name:'LEGEND',      icon:'⚡',
    ...
    rageCompatible:false, weaponType:'Staff / Reach', domainType:'None',
  ...
  { id:'oo',        name:'O.O',         icon:'👁',
    ...
    rageCompatible:false, weaponType:'Twin tools', domainType:'None',
  ...
  { id:'ree',       name:'REE',         icon:'🎙',
    ...
    playable:true,  temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Microphone / Crowd', domainType:'Sound-echo',
  ...
  { id:'knight',    name:'KNIGHT',      icon:'♞',
    ...
    rageCompatible:false, weaponType:'Shield / Counter', domainType:'Pattern-read',
  ...
  { id:'neonkd',    name:'NEONKD',      icon:'🌐',
    ...
    rageCompatible:false, weaponType:'Digital arms', domainType:'Signal-cut',
  ...
  { id:'yassine',   name:'YASSINE',     icon:'🌙',
    ...
    playable:true,  temporary:false, trust:0,  memory:0,
    rageCompatible:true,  weaponType:'Hands / Muscle-read', domainType:'Body-memory',
  ...
  { id:'friend',    name:'FRIEND',      icon:'❓',
    ...
    rageCompatible:false, weaponType:'Unknown', domainType:'Unknown',
    assistSkill:'???',
  ...
  { id:'mr_clone',  name:'M.R CLONE',   icon:'🪞',
    ...
    playable:true,  temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Adaptive', domainType:'Mirror-echo',
  ...
  { id:'raevan',    name:'RAEVAN',      icon:'🏹',
    ...
    rageCompatible:false, weaponType:'Bow / Countershot', domainType:'Precision-field',
  ...
  { id:'kaizen',    name:'KAIZEN',      icon:'🔥',
    ...
    rageCompatible:true,  weaponType:'Bare hands', domainType:'Furnace-field',
    assistSkill:'Rage Discipline',
    codexText:'"Power is not permission to become stupid faster."' },

  { id:'sorya',     name:'LADY SORYA',  icon:'🌀',
    status:'support',   allegiance:'teacher', role:'Sage · Domain Guide',
    playable:false, temporary:false, trust:85, memory:100,
    rageCompatible:false, weaponType:'Domain control', domainType:'Corridor-fold',
    assistSkill:'Domain Open',
  ...
  { id:'harjeev',   name:'HARJEEV',     icon:'📋',
    ...
    rageCompatible:false, weaponType:'None', domainType:'None',
    assistSkill:'Camp Order',
    codexText:'Stops being just manager the moment people start dying.' },

  // ── ENEMIES — DRAKOS ──────────────────────────────────────────
  { id:'varkul',    name:'VARKUL',      icon:'⚔',
    status:'enemy',     allegiance:'drako',   role:'Drako No.11 · March',
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Pressure advance', domainType:'Territory-march',
    assistSkill:'—',
  ...
  { id:'zeigran',   name:'ZEIGRAN',     icon:'🌋',
    ...
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Scorching pressure', domainType:'Heat-line',
    assistSkill:'—',
  ...
  { id:'dread_juno',name:'DREAD JUNO',  icon:'☠',
    ...
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Scythe domain', domainType:'Scythe-arc',
    assistSkill:'—',
  ...
  { id:'kaith',     name:'KAITH',       icon:'⛓',
    ...
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Chain anchors', domainType:'Chain-domain',
    assistSkill:'—',
  ...
  { id:'rhaziel',   name:'RHAZIEL',     icon:'🔕',
    ...
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Null-bell', domainType:'Null-field',
    assistSkill:'—',
    codexText:'Turns domains off like lamps. Part 41.' },

  // ── ENEMIES — NEXTERS ─────────────────────────────────────────
  { id:'kade',      name:'KADE',        icon:'📐',
    status:'enemy',     allegiance:'nexter',  role:'Nexter No.2 · Precision',
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Calculated strikes', domainType:'Mark-field',
    assistSkill:'—',
  ...
  { id:'lynex',     name:'LYNEX',       icon:'🐍',
    ...
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Whip-range', domainType:'Encircle',
    assistSkill:'—',
  ...
  { id:'riven',     name:'RIVEN',       icon:'🎯',
    ...
    playable:false, temporary:false, trust:0,  memory:0,
    rageCompatible:false, weaponType:'Long-range', domainType:'Unknown',
    assistSkill:'—',
...
function _renderRoster() {
  ...
  list.innerHTML = records.map(r => {
    ...
    if (!isLocked && r.domainType && r.domainType !== 'None' && r.domainType !== 'None (yet)') tags.push(`<span class="rd-tag domain">${r.domainType}</span>`);
...
const CAMP_MISSIONS = [
  ...
  { id:'hunt_morvain',  part:32, endPart:35, title:'Hunt Morvain',        desc:'Morvain\'s domain makes him near-invisible. Find the angle.',type:'hunt' },
  { id:'free_oo',       part:21, endPart:35, title:'Recover O.O',         desc:'O.O\'s hands still know Chug. Help him remember.',     type:'recovery' },
  { id:'domain_kaith',  part:36, endPart:38, title:'Break Kaith\'s Chains',desc:'The chain domain turns teammates into liabilities.',   type:'boss'     },
...
//          escortMission · campEvent · domainBattle
//          multiWaveBattle
// ════════════════════════════════════════════════════════════════
...
const MISSION_FTYPES = {
  ...
  domainBattle:   10,  // domain-strength enemy
...
//    domain — teacher: Sorya   — prepares battlefield/domain unlocks
//
...
//  Nodes stored per-path: __saveData.trainingNodes = { range:{}, rage:{}, domain:{} }
// ════════════════════════════════════════════════════════════════
...
const TRAINING_PATHS = {
  ...
  domain: {
    ...
    icon: '🌀',
    color: '#aa00ff',
    unlockPart: 18,   // Sorya teaches at part 18
    desc: 'Shape the battlefield before the fight begins. Sorya teaches corridor-folding, domain reading, and spatial combat.',
    nodes: [
      { id:'domain_1', tier:1, title:'Open the Corridor',
        effect:'Domain awareness I · learn to read pocket domains',
        reqPart:18, reqNode:null,
        passive:{ type:'flag', flag:'domain_awareness_1', desc:'First stable domain pocket introduced.' } },
      { id:'domain_2', tier:2, title:'Fold the Space',
        effect:'Corridor-fold foundation · close distance through domain (future)',
        reqPart:26, reqNode:'domain_1',
        passive:{ type:'none', desc:'Chug learns to fold a corridor in front of him.' } },
      { id:'domain_3', tier:3, title:'Chain Geometry',
        effect:'Counter chain-domains (Kaith) · geometry reading unlocked',
        reqPart:38, reqNode:'domain_2',
        passive:{ type:'flag', flag:'domain_chain_counter', desc:'Understand anchor points before they trap you.' } },
      { id:'domain_4', tier:4, title:'Null Resistance',
        effect:'Reduce null-field penalty (Rhaziel) · maintain Rage in silence',
        reqPart:41, reqNode:'domain_3',
        passive:{ type:'flag', flag:'domain_null_resist', desc:'Fight without tricks. Only pain and timing.' } },
      { id:'domain_5', tier:5, title:'Pocket Domain I',
        effect:'Unlock personal domain activation (placeholder hook)',
        reqPart:45, reqNode:'domain_4',
        passive:{ type:'flag', flag:'domain_pocket_1', desc:'The first space that belongs to Chug.' } },
      { id:'domain_6', tier:6, title:'War Domain',
        effect:'Full domain combat — battlefield geometry mastery (placeholder)',
        reqPart:50, reqNode:'domain_5',
        passive:{ type:'flag', flag:'domain_war', desc:'Own the space. Own the fight.' } },
    ],
  },
};
...
function _trainingNodes() {
  if (!window.__saveData) return {};
  if (!window.__saveData.trainingNodes) window.__saveData.trainingNodes = { range:{}, rage:{}, domain:{} };
...
//  B. DOMAIN / ARENA MODIFIER FRAMEWORK
//  C. CODEX (enemy / boss / faction records)
//  D. TRUST / MEMORY / BETRAYAL SYSTEM
//
//  All data lives in __saveData.  No combat engine changes.
//  Placeholders are clearly marked [PLACEHOLDER].
// ════════════════════════════════════════════════════════════════

// ════════════════════════════════════════════════════════════════
//  A. RANGED WEAPON FRAMEWORK
// ════════════════════════════════════════════════════════════════
// Ranged weapons are data records only.  Projectile firing is
// [PLACEHOLDER] — hooks exist but no new canvas draw loop.
// The existing weapon variable (melee) is separate.

const RANGED_WEAPON_DATA = {
  bow:        { id:'bow',        name:'Shadow Bow',     icon:'🏹', dmg:12, cooldown:60, range:'long',   unlockPart:16, reqFlag:'countershot_1', desc:'Raevan\'s first gift. Slow draw, precise.' },
  counterbow: { id:'counterbow', name:'Counter Bow',    icon:'🏹', dmg:16, cooldown:48, range:'long',   unlockPart:35, reqFlag:'countershot_2', desc:'Tuned for intercepting moving targets.' },
  crossbow:   { id:'crossbow',   name:'Void Crossbow',  icon:'🎯', dmg:20, cooldown:36, range:'medium', unlockPart:45, reqFlag:'countershot_2', desc:'Fast reload. Short arc. Punishing.' },
  throwknife: { id:'throwknife', name:'Throw Knife',    icon:'🔪', dmg:9,  cooldown:24, range:'short',  unlockPart:24, reqFlag:null,            desc:'Close-range arc. Always available.' },
};

// Active ranged weapon slot (separate from melee `weapon`)
// Stored in __saveData.rangedWeapon
let rangedWeapon = 'none';

function getRangedWeapon() {
  return (window.__saveData && window.__saveData.rangedWeapon) || 'none';
}

function setRangedWeapon(id) {
  if (id !== 'none' && !RANGED_WEAPON_DATA[id]) return;
  if (window.__saveData) window.__saveData.rangedWeapon = id;
  rangedWeapon = id;
  if (typeof saveGame === 'function') saveGame();
}

function isRangedWeaponUnlocked(id) {
  const def = RANGED_WEAPON_DATA[id];
  if (!def) return false;
  const reached = window.__saveData && window.__saveData.currentPart
    ? window.__saveData.currentPart : (typeof currentPart !== 'undefined' ? currentPart : 1);
  if (reached < def.unlockPart) return false;
  if (def.reqFlag) {
    const cp = window.__saveData && window.__saveData.codexProgress;
    if (!cp || !cp[def.reqFlag]) return false;
  }
  return true;
}

function getUnlockedRangedWeapons() {
  return Object.values(RANGED_WEAPON_DATA).filter(w => isRangedWeaponUnlocked(w.id));
}

// [PLACEHOLDER] — called when player fires ranged weapon during combat.
// Actual projectile draw/collision left for future pass.
function fireRangedWeapon(x, y, dir) {
  const id  = getRangedWeapon();
  const def = RANGED_WEAPON_DATA[id];
  if (!def) return false;
  if (!window.__rangedCooldown) window.__rangedCooldown = 0;
  if (window.__rangedCooldown > 0) return false;
  window.__rangedCooldown = def.cooldown;
  // [PLACEHOLDER] projectile spawn — no canvas effect yet
  return true;
}

// Tick cooldown each frame (call from game loop if desired — safe no-op if not)
function tickRangedCooldown() {
  if (window.__rangedCooldown > 0) window.__rangedCooldown--;
}

window.RANGED_WEAPON_DATA     = RANGED_WEAPON_DATA;
window.getRangedWeapon        = getRangedWeapon;
window.setRangedWeapon        = setRangedWeapon;
window.isRangedWeaponUnlocked = isRangedWeaponUnlocked;
window.getUnlockedRangedWeapons = getUnlockedRangedWeapons;
window.fireRangedWeapon       = fireRangedWeapon;
window.tickRangedCooldown     = tickRangedCooldown;

// ════════════════════════════════════════════════════════════════
//  B. DOMAIN / ARENA MODIFIER FRAMEWORK
// ════════════════════════════════════════════════════════════════
// A domain is a lightweight object that modifies fight parameters.
// Applied per-mission via __activeDomain.  No visual overhaul.
// Modifiers are read by combat hooks that already call getRageModifiers().

const DOMAIN_DEFS = {
  none:         { id:'none',         name:'Normal',           icon:'',   desc:'No domain active.',
                  mods:{} },
  pressure_zone:{ id:'pressure_zone',name:'Pressure Zone',    icon:'🌀', desc:'Enemy advances faster. Knockback reduced.',
                  mods:{ enemySpeedMul:1.20, knockbackMul:0.65 } },
  rage_suppress:{ id:'rage_suppress',name:'Null Field',       icon:'🔕', desc:'Rage meter fills 50% slower. Domain abilities muted.',
                  mods:{ rageGainMul:0.50, rageDrainMul:1.40 } },
  hazard_zone:  { id:'hazard_zone',  name:'Hazard Zone',      icon:'⚠',  desc:'Both fighters take ambient chip damage each round.',
                  mods:{ chipDmgPerRound:5 } },
  slow_field:   { id:'slow_field',   name:'Slow Field',       icon:'🕯', desc:'All movement speed reduced 20%.',
                  mods:{ playerSpeedMul:0.80, enemySpeedMul:0.80 } },
  heat_line:    { id:'heat_line',    name:'Heat Line',        icon:'🌋', desc:'Zeigran\'s domain. Stamina drains faster.',
                  mods:{ staminaDrainMul:1.50 } },
  chain_domain: { id:'chain_domain', name:'Chain Domain',     icon:'⛓', desc:'Kaith\'s anchors. Knockback reversed; enemies hold position.',
                  mods:{ knockbackMul:0.20, enemyKnockbackMul:1.60 } },
  null_field:   { id:'null_field',   name:'Null Chapel',      icon:'🔇', desc:'Rhaziel\'s silence. Rage suppressed; extra damage on player.',
                  mods:{ rageGainMul:0.0, playerDmgMul:1.30 } },
  echo_field:   { id:'echo_field',   name:'Echo Field',       icon:'🌊', desc:'Memory domain. Ghosts of past fights appear as particle trails.',
                  mods:{} },  // visual only [PLACEHOLDER]
};

// __activeDomain is set per-mission; null = no domain
window.__activeDomain = null;

function setActiveDomain(id) {
  window.__activeDomain = DOMAIN_DEFS[id] || DOMAIN_DEFS.none;
}
...
function getActiveDomainMods() {
  return (window.__activeDomain && window.__activeDomain.mods) || {};
}

/** Convenience: get a single domain modifier value with a safe default. */
function getDomainMod(key, defaultVal) {
  const mods = getActiveDomainMods();
  return mods[key] !== undefined ? mods[key] : defaultVal;
}

// Patch startRound to apply domain mods to player/enemy post-construction.
// Deferred — startRound is defined later in the script.
function _patchStartRoundForDomain() {
  const _orig = typeof startRound === 'function' ? startRound : null;
  if (!_orig || _orig.__domainPatched) return;
  window.startRound = function(n) {
    _orig.call(this, n);
    const mods = getActiveDomainMods();
    if (!mods || !Object.keys(mods).length) return;
    if (typeof player !== 'undefined' && player) {
      if (mods.playerSpeedMul)   player.spd   *= mods.playerSpeedMul;
      if (mods.playerDmgMul)     player.dmg   *= mods.playerDmgMul;
      if (mods.rageGainMul !== undefined) player._domainRageGainMul = mods.rageGainMul;
      if (mods.rageDrainMul !== undefined) player._domainRageDrainMul = mods.rageDrainMul;
    }
    if (typeof enemy !== 'undefined' && enemy) {
      if (mods.enemySpeedMul)    enemy.spd    *= mods.enemySpeedMul;
    }
  };
  window.startRound.__domainPatched = true;
  window.startRound.__rageTierPatched = true; // preserve existing flag
}

// Patch takeHit to apply knockback domain modifier.
// Deferred — Fighter is defined later in the script.
function _patchTakeHitForDomain() {
  if (typeof Fighter === 'undefined' || !Fighter.prototype) return;
  const _orig = Fighter.prototype.takeHit;
  if (!_orig || _orig.__domainPatched) return;
  Fighter.prototype.takeHit = function(dmg, fd, heavy) {
    _orig.call(this, dmg, fd, heavy);
    const mods = getActiveDomainMods();
    if (mods.knockbackMul && this.vx !== 0) this.vx *= mods.knockbackMul;
  };
  Fighter.prototype.takeHit.__domainPatched  = true;
  Fighter.prototype.takeHit.__rescuePatched  = true; // preserve flag
}

window.DOMAIN_DEFS       = DOMAIN_DEFS;
window.setActiveDomain   = setActiveDomain;
window.clearActiveDomain = clearActiveDomain;
window.getActiveDomainMods = getActiveDomainMods;
window.getDomainMod      = getDomainMod;
...
const CODEX_RECORDS = [
  ...
  { id:'dread_juno', name:'DREAD JUNO',       icon:'☠',  cat:'boss',    faction:'Drako', introPartRef:37,
    ...
    desc:'A midnight raid turns the camp into a red-lit slaughterground. His scythe domain halves the distance between alive and not.' },
  { id:'kaith',      name:'KAITH',            icon:'⛓',  cat:'boss',    faction:'Drako', introPartRef:38,
    title:'Drako No.8 — Chain Domain',
  ...
  { id:'rhaziel',    name:'RHAZIEL',          icon:'🔕', cat:'boss',    faction:'Drako', introPartRef:39,
    ...
    desc:'The null-bell turns domains off like lamps. Forces everyone to fight without tricks, only pain and timing.' },
  { id:'morvain',    name:'MORVAIN',          icon:'🎭', cat:'enemy',   faction:'Drako', introPartRef:34,
    title:'Drako — The Masked Laugh',
    desc:'Domain makes him near-invisible. Raevan teaches Chug to shoot where Morvain will lie, not where he stands.' },
  // ── ENEMIES — NEXTERS ──
  ...
  { id:'xollonox',   name:'XOLLONOX',         icon:'🌑', cat:'boss',    faction:'Unknown', introPartRef:49,
    ...
    desc:'The last named obstruction before the gate. Its domain has no recorded weaknesses yet.' },
...
function _renderCodex() {
  ...
  const FILTER_META = {
    ...
    boss:     { label:'Threat Ledger', title:'Boss Dossiers',    note:'Named threats, domain users, and high-priority enemies worth tracking.' },
...
// ── INPUT ──
window.K={l:0,r:0,j:0,a:0,k:0,g:0,t:0,rage:0}; const K=window.K;
...
life:0.5+Math.random()*0.3,col:swingCol,w:Math.random()*16+8,tp:'s'});
    ...
    if(this.isP){
      if(K.rage&&this.rage>=100&&!this.rageActive){
        ...
        shadowSlash(this.x+this.w/2,this.y,this.dir,this.rageTier===3?'#d44cff':this.rageTier===2?'#ff3a3a':'#66e8ff');
        const _rmL=typeof getRageModifiers==='function'?getRageModifiers(this.rageTier):null;
        floatingTexts.push({x:this.x+this.w/2,y:this.y-this.h-10,t:_rmL?_rmL.labelShort:(this.rageTier===2?'BLOOD RAGE':'SHADOW RAGE'),life:1.05,vy:-2.1,col:this.rageTier===3?'#d44cff':this.rageTier===2?'#ff6a6a':'#7de7ff',size:18});
      }
      if(this.rageActive){
        this.rage-=0.15;
    ...
    if(this.hitT>0){this.hitT--;this.vx*=0.83;if(this.y<GND)this.rotation+=0.15*this.dir;}
      ...
      if(this.atkT===this.hitF){
        ...
        if(!this.isP&&this.eWeapon==='staff')reach+=50*this.scale;
        if(!this.isP&&this.eWeapon==='hammer')reach+=40*this.scale;
        if(!this.isP&&this.eWeapon==='scythe')reach+=75*this.scale;
  ...
  draw(c,ghost=false){
    ...
    if(this.state==='grab_exec'){
      ...
      // JUMP KICK — knee drives up then leg extends
      const _ext=this.atkT<this.hitF+4?1.0:_atkProg*0.6;
      bFootX=-14;bFootY=0;bKneeX=-16;bKneeY=-28;
      fFootX=26+_ext*32;fFootY=waistY+10+_ext*22;fKneeX=16+_ext*14;fKneeY=waistY-2+_ext*10;
    } else if(_isAirAtk&&this.atkType==='p'){
      // JUMP PUNCH — legs tucked
      ...
      // Tuck legs airborne
      const _tk=Math.min(1,Math.abs(this.vy)/16);
      bFootX=-14;bFootY=_tk*-16;bKneeX=-18;bKneeY=-26-_tk*8;
      fFootX=16;fFootY=_tk*-10;fKneeX=12;fKneeY=-22-_tk*6;
    } else if(this.state==='atk'&&this.y<GND-20&&this.atkType==='k'){
      // Jump kick - extend leg forward
      const _kp=this.atkT<this.hitF+4?1.0:0.5;
      bFootX=-14;bFootY=0;bKneeX=-16;bKneeY=-28;
      fFootX=26+_kp*32;fFootY=waistY+10+_kp*22;fKneeX=16+_kp*14;fKneeY=waistY-2;
    } else if(this.state==='atk'&&this.y<GND-20&&this.atkType==='p'){
      // Jump punch - tuck legs
      bFootX=-10;bFootY=-6;bKneeX=-14;bKneeY=-22;
      fFootX=12;fFootY=-10;fKneeX=8;fKneeY=-20;
    } else {
    ...
    if(!this.isP&&!ghost&&this.eWeapon&&this.eWeapon!=='none'){
      ...
      if(ew==='knuckle'){
        ...
        c.fillStyle='#222';c.fillRect(-14,-5,22,10);
        const kkk=c.createLinearGradient(8,-2,70,2);
        kkk.addColorStop(0,'#bbb');kkk.addColorStop(0.4,'#eee');kkk.addColorStop(1,'#888');
        c.fillStyle=kkk;c.beginPath();c.moveTo(8,-2);c.lineTo(68,0);c.lineTo(8,2);c.closePath();c.fill();
        c.strokeStyle='rgba(200,200,255,0.5)';c.lineWidth=1;
        c.beginPath();c.moveTo(10,-1);c.lineTo(66,0);c.stroke();
        if(eHit){c.shadowColor='rgba(200,0,0,0.9)';c.shadowBlur=18;}
      } else if(ew==='staff'){
        const spg2=c.createLinearGradient(-50,-4,50,4);
        spg2.addColorStop(0,'#1a1410');spg2.addColorStop(0.5,'#2e2416');spg2.addColorStop(1,'#1a1410');
        c.fillStyle=spg2;c.fillRect(-50,-4,100,8);
...
function _setSpeakerPortrait(baseSpeaker){
  ...
  const emoji = SPEAKER_ICONS[baseSpeaker] || '⚔';
  icon.textContent = emoji;
  if(baseSpeaker){
    dava.style.display = 'flex';
  } else {
    dava.style.display = 'none';
  }
}
...
function renderDialogue(s){
  ...
  // Avatar/portrait
  if(baseSpeaker){
    UI.dname.innerText=speaker; UI.dname.style.display='block';
...
loadGame();loadSettings();applyPartBg(1);refreshMenuLocks();loop();
...
_patchStartRoundForDomain();
_patchTakeHitForDomain();
...
let _lvl=1, _xp=0, _statPoints=0;
let _stats={hp:0,atk:0,def:0,spd:0,crit:0};
let _gems=0;
let _luPending={hp:0,atk:0,def:0,spd:0,crit:0};
let _luLeft=0;
...
function updateV9Display(){
  ...
  const lv=document.getElementById('lv-val'); if(lv)lv.innerText=_lvl;
  updateXPBar();
}
function updateXPBar(){
  const need=_lvl<50?XP_TABLE[_lvl-1]:XP_TABLE[49];
  const pct=Math.min(100,(_xp/need*100));
  const b=document.getElementById('p-xp'); if(b)b.style.width=pct+'%';
}
...
function updateGems(amt){
  ...
  const gv=document.getElementById('gem-val'); if(gv)gv.innerText=_gems;
  const gg=document.getElementById('global-gems');
  if(gg){gg.style.transform='scale(1.4)';setTimeout(()=>gg.style.transform='scale(1)',200);}
  v9SaveGame();
}
...
function openWorldMap(){
  ...
  document.getElementById('global-gems').style.display='flex';
  document.getElementById('global-level').style.display='flex';
  document.getElementById('global-coins').style.display='block';
  // Start panel closed
  const scr = document.getElementById('worldmap-screen');
...
function closeWorldMap(){
  document.getElementById('global-gems').style.display='none';
  document.getElementById('global-level').style.display='none';
  document.getElementById('global-coins').style.display='none';
  showScreen('menu-screen');
}
...
function startChapterV9(ch){
  ...
  setTimeout(()=>{
    ...
    setTimeout(()=>{
      ...
      document.getElementById('global-gems').style.display='flex';
      document.getElementById('global-level').style.display='flex';
      document.getElementById('btn-ingame-menu').style.display='block';
      const save=window.__saveData||{};
      const unlk=save.chapterUnlocked||1;
...
buyItem = function(kind,name,price,currency){
  ...
  if(currency==='gem'){
    ...
    if(kind==='weapon'){
      weapon=name;
      ['knuckle','dagger','katana','staff','scythe','claws','hammer','sword','nunchaku','knives','spear','whip'].forEach(n=>{document.getElementById('buy-'+n)?.classList.remove('bought');});
      document.getElementById('buy-'+name)?.classList.add('bought');
      saveGame();shopToast('✓ EQUIPPED: '+name.toUpperCase());
    } else if(kind==='armor'){
      armor=name;
...
startRound = function(n){
  ...
  if(player&&player.isP){
    ...
    const wBon={sword:8,nunchaku:7,knives:6,spear:12,whip:9};
    const wSpd={sword:0,nunchaku:3,knives:2,spear:-1,whip:0};
...
(function runIntro(){
  ...
  if (cv) {
    ...
    // Spawn sparse particles: slow-rising embers + faint horizontal streaks
    function spawnDot() {
      const isStreak = Math.random() < 0.18;
      dots.push({
        x:  Math.random() * cv.width,
        y:  cv.height + Math.random() * 60,
        vx: (Math.random() - 0.5) * (isStreak ? 1.4 : 0.25),
        vy: -(Math.random() * (isStreak ? 0.4 : 0.6) + 0.15),
        life: 0, maxLife: 180 + Math.random() * 240,
        r:  Math.random() * (isStreak ? 1.2 : 1.8) + 0.4,
        streak: isStreak,
    ...
    function drawDots() {
      ...
      for (let i = dots.length - 1; i >= 0; i--) {
        ...
        const a   = alpha * (d.streak ? 0.18 : 0.28);
        if (d.streak) {
          ctx2.save();
          ctx2.globalAlpha = a;
          const g = ctx2.createLinearGradient(d.x - 18, d.y, d.x + 18, d.y);
          g.addColorStop(0,   'transparent');
          g.addColorStop(0.5, d.gold ? 'rgba(212,160,23,1)' : 'rgba(200,180,140,1)');
          g.addColorStop(1,   'transparent');
          ctx2.fillStyle = g;
          ctx2.fillRect(d.x - 18, d.y - d.r, 36, d.r * 2);
          ctx2.restore();
        } else {
          ctx2.save();
          ctx2.globalAlpha = a;
          ...
          ctx2.fillStyle = d.gold ? 'rgba(212,160,23,0.9)' : 'rgba(220,200,160,0.7)';
          ctx2.fill();
          ctx2.restore();
        }
      }
      // Maintain ~55 particles
      while (dots.length < 25) spawnDot();
      if (intro.classList.contains('active-screen')) raf = requestAnimationFrame(drawDots);
    }
    // Pre-seed particles so screen isn't empty on load
    for (let i = 0; i < 20; i++) {
      spawnDot();
      const d = dots[dots.length - 1];
      d.y = Math.random() * cv.height;
      d.life = Math.random() * d.maxLife * 0.7;
    }
    drawDots();
